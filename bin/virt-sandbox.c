...
int main(int argc, char **argv) {
    ...
    GOptionEntry options[] = {
        ...
        { "disk", ' ', 0, G_OPTION_ARG_STRING_ARRAY, &disks,
          N_("add a disk in the guest"), "TYPE:TARGET=SOURCE:FORMAT" },
...
and type B<TYPE> and format B<FORMAT>. Example: file:hda=/var/lib/sandbox/demo/tmp.qcow2:qcow2

=over 4

=item B<TYPE>

Type parameter can be set to "file", "block", "dir", "network".

=item B<TARGET>

Target parameter can be set to "hda"
