                                                               ...
                                                               GError **error)
{
    ...
    while(tmp){
        ...
        if (GVIR_SANDBOX_IS_CONFIG_DISK(dconfig)){
            ...
            gvir_config_domain_disk_set_type(disk,gvir_sandbox_config_disk_get_disktype(dconfig));
            gvir_config_domain_disk_driver_set_format(diskDriver,gvir_sandbox_config_disk_get_diskformat(dconfig));
            ...
            gvir_config_domain_disk_set_target_dev(disk,gvir_sandbox_config_disk_get_target(dconfig));
